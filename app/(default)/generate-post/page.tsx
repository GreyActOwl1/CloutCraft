          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 dark:text-gray-200 mb-8">
                Supercharge your LinkedIn experience with AI-generated posts
              </p>
            </div>
          </div>
            ...
            <div className="p-6">
              <div className="mb-6">
                ...
                <p className="text-white text-sm">
                  Hello! To get the best results from this LinkedIn post
                  generator, be as specific as possible with your prompt.
                  Include details such as target audience, industry context,
                  personal anecdotes, specific achievements, or unique insights
                  you want to share. The more precise and rich your input, the
                  more tailored and engaging the output will be.
                </p>
                <p className="text-white text-sm mt-2">
                  For example, instead of just saying &quot;Write about leadership,&quot;
                  you could say &quot;Write about a time I learned a valuable
                  leadership lesson while managing a remote team during the
                  pandemic, focusing on communication strategies that boosted
...
//     Headings in the Post must be bold
...
//         <div className="pt-32 pb-12 md:pt-40 md:pb-20">
//           <div className="text-center pb-12 md:pb-16">
//             <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter text-gray-800 dark:text-white tracking-tighter mb-4">
//             {/* Generate a <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-indigo-400">LinkedIn Post</span>
//            */}
//            Generate a LinkedIn Post
//            </h1>
//             <div className="max-w-3xl mx-auto">
//               <p className="text-xl text-gray-600  dark:text-gray-200 mb-8">Supercharge your LinkedIn experience with AI-generated posts</p>
//             </div>
//           </div>
