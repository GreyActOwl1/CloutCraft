        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Profile Optimization</h4>
              <p className="text-lg text-gray-400 text-center">Enhance your LinkedIn profile with<br></br>  AI-driven tips.<br></br> Get personalized suggestions for your headline, summary, experience, skills, and endorsements, along with keyword recommendations and profile scoring.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Content Creation</h4>
              <p className="text-lg text-gray-400 text-center">Generate tailored post ideas and manage your LinkedIn content with ease. Use our content calendar to schedule posts and track engagement metrics.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Networking Management</h4>
              <p className="text-lg text-gray-400 text-center">Effortlessly grow your network. Receive connection recommendations, engagement reminders, and alerts for industry events and webinars.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Analytics and Reporting</h4>
