          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Link href="/" className="inline-block" aria-label="Cruip">
                  <img src="/images/cloutcraft.png" alt="Logo" className="w-40 h-40" />
                </Link>
              </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">More</h6>
                {/*
                <ul>
                  <li className="mb-1">
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">AI Post Generator</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">AI Porfile Analyzer</Link>
                  </li>
                  {/*}
                  <li className="mb-1">
              ...
              {/* 3rd block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Coming</h6>
                {/*}
                <ul>
                  <li className="mb-1">
              ...
              {/* 4th block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Soon!</h6>
                {/*
                <ul>
                  <li className="mb-1">
